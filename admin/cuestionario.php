                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Cuestionarios</h5>
                                            <p class="m-b-0">A continuación, se presentan los cuestionarios registrados</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="row">
                                    <div class="col-sm-12">
								<span class="btn btn-primary" data-toggle="modal" data-target="#insertarModalCu" onclick="pasarNumeroPregunta('<?php echo $datosNumero;?>')">
									<i class="fas fa-plus-circle"></i> Crear Cuestionario
								</span>
							</div>
						
                                    <!-------
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalNuevoCuestionario" onclick="pasarNumeroPregunta('<?php echo $datosNumero;?>')"><img class="bateria" src="ImagenesProgramacion/RegistraNuevo.png"></button>
                                    --->
                                </div>
						</div> 
                                        </br>
...
-->
    ...
    <?php require_once "modalInsertCu.php" ?>
    <?php require_once "modalUpdateCu.php" ?>
    ...
    <script src="js/crudCu.js"></script>
