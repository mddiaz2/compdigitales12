...
<body>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">A continuación, se presentan los reportes registrados</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
    ...
    <?php require_once "modalInsertP.php" ?>
  
	<?php require_once "modalUpdateP.php" ?>
