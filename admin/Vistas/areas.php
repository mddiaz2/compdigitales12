                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <p class="m-b-0">A continuación, se presentan los niveles
                                                        registrados</p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
     ...
     <!-- Page-body start -->
         ...
         <div class="col-sm-12">
                                                        <span class="btn btn-primary" data-toggle="modal"
                                                            data-target="#insertarModalA">
                                                            <i class="fas fa-plus-circle"></i> Nueva Area
                                                        </span>
                                                    </div>
                                                </div>
                                                </br>
...
<!--Función para mostrar los datos de áreas---->
                                            <div id="tablaDatosA"></div>
                                            </div>
                                            <!-- Page-body end -->
                                        </div>  </div>
                                    <!-- Main-body end -->
            ...
            <?php require_once "modalInsertA.php" ?>

            <?php require_once "modalUpdateA.php" ?>
